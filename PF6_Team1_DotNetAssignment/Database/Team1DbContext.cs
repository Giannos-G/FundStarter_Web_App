...
namespace PF6_Team1_DotNetAssignment.Database
{
    public class Team1DbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=tcp:pf6-db-team1.database.windows.net,1433;Initial Catalog=PF6_Team1_DotNetAssignment_db;Persist Security Info=False;User ID=vgerokostas@athtech.gr@pf6-db-team1;Password={6982805533Bb};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        }
